  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Chứng khoán</Text>
      </View>
      <View style={{ flexDirection: "row", marginLeft: 15, marginTop: 20 }}>
        ...
        >
          <Image
            source={require("../../assets/imgtaichinh/icon-chungkhoan.jpg")}
        ...
        >
          <Image
            source={require("../../assets/imgtaichinh/icon-nhantienkieuhoi.jpg")}
